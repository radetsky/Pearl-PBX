...
function Astman() {
	...
	this.parseResponse = function(t, callback, callback_dest) {
		var msgs = new Array();
		var inmsg = 0;
		var msgnum = 0;
		var x,y;
		...
		callback(msgs, callback_dest);
	};
	this.managerResponse = function(t) {
		me.parseResponse(t, me.callback, me.callback_dest);
	};
	...
	this.sendRequest = function(request, callback, callback_dest) {
