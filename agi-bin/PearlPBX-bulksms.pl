...
#===============================================================================
#
#         FILE:  PearlPBX-bulksms.pl
#
#        USAGE:  ./PearlPBX-bulksms.pl
#
#  DESCRIPTION:  Sends message from parameters to all internal or selected users
#
#      OPTIONS:  <List,Of,Users> || <INTERNAL>, [<subst>], [<Display From>]
