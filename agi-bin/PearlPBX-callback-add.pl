...
#      CREATED:  29.12.2014
#     MODIFIED:  08.10.2018
#     MODIFIED:  27.10.2023 For shorts number
#===============================================================================

#===============================================================================
# 2023 changes
#
# if $optional > 10 then it is a seconds to wait for callback
# Example: callback_add ${CALLERID(num)}, evakuator, 180
# to call after 3 minutes
